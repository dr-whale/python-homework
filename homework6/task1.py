...
def progression(a1 = int(), d = int(), n = int()):
    responce_list = [(a1 + i*d) for i in range(n)]
    return responce_list

a1, d, n = map(int, input('Введите первый элемент, шаг и количество через пробел: ').split())
